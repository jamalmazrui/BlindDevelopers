...
subtitle: "Contemporary Apps Built While Blind or Low Vision"
author: "Jamal Mazrui"
date: "June 2026"
version: "v2.1.0"
lang: en-US
...
This directory lists 26 developers who are blind or have low vision, along with software each has built. It is meant in part as a resource for aspiring blind developers, and as a way to find and reach the developers listed.

A developer is included when they were blind or had low vision while creating the work and have at least one app or tool reachable through a working link. The focus is software active in the year 2020 or later, so long-running tools such as JAWS, NVDA, and Emacspeak appear alongside newer projects. Up to three projects are shown per developer, followed by a "Profiles:" line with GitHub, a website, or other relevant pages.
...
Profiles: [taylorarndt.com](https://taylorarndt.com/), [LinkedIn](https://www.linkedin.com/in/taylor-arndt-3ab16a142/).
...
#### [GLOW Accessibility Toolkit](https://accessibleworld.org/) {#glow}
An AI-driven accessibility hub for information sharing and collaboration, published through Accessible World.
...
Profiles: [LinkedIn](https://www.linkedin.com/in/mikedoise), [App Store](https://apps.apple.com/us/developer/michael-doise/id586844934).
...
An accessible weather app for Apple platforms, written in Swift.
...
Profiles: [LinkedIn](https://www.linkedin.com/in/bgaraventa/), [WhatSock on GitHub](https://github.com/WhatSock), [WhatSock](https://whatsock.com/).
...
Software Fellow at Freedom Scientific, the original architect of the JAWS screen reader and host of the FSCast podcast.
Profiles: [Freedom Scientific](https://www.freedomscientific.com/).
...
Profiles: [dlee.org](https://www.dlee.org/).
...
Profiles: [GitHub](https://github.com/jamalmazrui), [EmpowermentZone](http://EmpowermentZone.com/).
...
Profiles: [LinkedIn](https://www.linkedin.com/in/ken-perry-70637b5/), [APH](https://www.aph.org/).
...
Profiles: [GitHub](https://github.com/tvraman), [home page](https://emacspeak.sourceforge.net/raman/), [blog](https://emacspeak.blogspot.com/), [Wikipedia](https://en.wikipedia.org/wiki/T._V._Raman).
...
Profiles: [GitHub](https://github.com/ctoth), [Accessible Apps](https://getaccessibleapps.com/).
...
Profiles: [GitHub](https://github.com/samtupy), [samtupy.com](https://samtupy.com/).
